...
class _WalletStrapSide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: SizeConfig.walletStrapWidth,
      height: SizeConfig.walletStrapHeight,
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.only(
          ...
          bottomRight: Radius.circular(SizeConfig.walletStrapWidth / 2),
          bottomLeft: Radius.circular(SizeConfig.walletStrapWidth / 2),
        ),
        boxShadow: [
          BoxShadow(
